...
static void usage (char *name)
{
	...
	fprintf(stderr, "Usage:\n\t%s <options> [path...]\n\n\t\t"
			...
			"-e, --ext <list>             \tList of file extension to search for\n\t\t"
			"-E, --ext-file <file>        \tUse <file> to get a list of extension to search for, one extension per line\n\t\t"
			"-i, --ignore-ext <list>      \tList of file extension to ignore\n\t\t"
			"-I, --ignore-ext-file <file> \tUse <file> to get a list of file extension to ignore, one extension per line\n\t\t"
